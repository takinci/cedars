...
| Schoen-CT-Idle | Cited in-app (`MODALITY_BENCHMARKS` CT row note: "Idle up to 66% of total") as "Schoen et al." — **undefined, not yet located.** Likely refers to J. Schoen (co-author of Brown M, Schoen JH, Gross J, Omary RA, Hanneman K. *Climate change and radiology: Impetus for change and a toolkit for action.* Radiology 2023;307:e230229, cited elsewhere in this document only via its DOI without an ID), but that paper's specific claim about CT idle-time percentage has not been confirmed. **[verify]** |
