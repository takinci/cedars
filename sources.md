...
> - **MRI**: Hernandez et al. 2026's two units (3T, 1.5T) both run 7 d/wk, 07:00–21:00, overnight mode "low power"/idle, never off — corroborates Woolen et al. 2023's finding that real MRI units are mostly left idle rather than truly off. Not applied: evidence remains genuinely inconsistent across sites (Woolen's 4 units alone ranged 2.5%–59.5% off-time), so no single number is defensible yet.
