...
const MRI_15T_TOOLTIP   = 'Superconducting: cryocooler idle draw (32 kW) often exceeds active scanning power (22 kW), and never fully stops — even "off" still draws 24 kW to prevent magnet quench (Woolen et al. Radiology 2023, doi:10.1148/radiol.230441, direct power-meter data: off 7.3-9.7 kW vs idle 9.5-14.5 kW on real scanners). Sources: Heye et al. JMRI 2023 (doi:10.1002/jmri.28994), Radiol 2024 (doi:10.1148/radiol.243453), EurRad 2024 (doi:10.1007/s00330-024-11056-0). Projected ~242 MWh/yr — dominated by cryocooler.';
const MRI_3T_TOOLTIP    = 'Active 30 kW from measured mean of 3T scanners: Heye et al. JMRI 2023 (doi:10.1002/jmri.28994). Idle 15 kW: Radiol 2024 (doi:10.1148/radiol.243453). Standby 5 kW: cryocooler minimum (Herrmann 2012). Off 11.25 kW — cryocooler cannot fully stop without risking quench (Woolen et al. Radiology 2023, doi:10.1148/radiol.230441). Projected ~131 MWh/yr. Replace with scanner logs if available.';
...
const WS_TOOLTIP        = 'Active 170 W per workstation, matching Thiel et al. Radiology 2024 (doi:10.1148/radiol.240398) — their own modelled reading-room workstation power (170 W, 60% daily use). Idle/standby/off are extrapolated proportionally, not independently sourced — Thiel\'s own model does not break those out separately. A 4-workstation department uses ~2.5 MWh/yr; screen-saver and end-of-day shutdown policies capture most of the avoidable idle energy. Count shared reading stations only.';
