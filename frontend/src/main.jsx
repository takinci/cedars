...
const MRI_15T_TOOLTIP   = 'Superconducting: idle 15 kW and off 10 kW from direct power-meter measurements across 4 real scanners, 3 vendors (Woolen et al. Radiology 2023, doi:10.1148/radiol.230441, Table 1: idle 10-15 kW, off 7-10 kW). The cryocooler cannot fully stop without risking magnet quench (helium boil-off), so "off" still draws substantial power — but idle never exceeds active/scan power in any real scanner Woolen measured. Active 22 kW: Heye et al. JMRI 2023 (doi:10.1002/jmri.28994), EurRad 2024 (doi:10.1007/s00330-024-11056-0). Projected ~123 MWh/yr.';
const MRI_3T_TOOLTIP    = 'Active 30 kW from measured mean of 3T scanners: Heye et al. JMRI 2023 (doi:10.1002/jmri.28994). Idle 15 kW and off 10 kW: direct power-meter data across 4 real scanners (Woolen et al. Radiology 2023, doi:10.1148/radiol.230441, Table 1: idle 10-15 kW, off 7-10 kW) — the cryocooler cannot fully stop without risking quench, so off draws substantially more than a simple "powered down" assumption. Standby 5 kW: cryocooler minimum (Herrmann 2012). Projected ~131 MWh/yr. Replace with scanner logs if available.';
